...
int RBS_0_VCU_VCU2OPUS_3_Init	(struct tRBS_SigPDU *pdu);

int RBS_0_VCU_VCU2OPUS_2_Init	(struct tRBS_SigPDU *pdu);

int RBS_0_VCU_VCU2OPUS_1_Init	(struct tRBS_SigPDU *pdu);
