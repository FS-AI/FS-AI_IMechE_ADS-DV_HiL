...
#if !defined(__RBS_0_FRAME_H__)
#define __RBS_0_FRAME_H__
...
int RBS_0_Rx_AI2VCU_Status_PreDecode	(struct tRBS_SigFrame *frm);
...
int RBS_0_Tx_VCU2AI_Status_CAN_Tx	(struct tRBS_SigFrame *frm, int slot, int channel);
int RBS_0_Tx_VCU2AI_Status_PreEncode	(struct tRBS_SigFrame *frm);
...
#endif /* #if !defined(__RBS_0_FRAME_H__) */
